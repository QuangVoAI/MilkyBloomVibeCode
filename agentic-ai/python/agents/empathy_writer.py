...
LLM backend hiện tại là Featherless qua adapter OpenAI-compatible,
nhưng giữ nguyên các entrypoint cũ để agentic pipeline không đổi.
"""
import sys
...
async def generate_empathy_streaming(
    ...
    if EMPATHY_MODE == "vertex":
        # Legacy branch giữ tương thích, nhưng backend sinh text vẫn là Featherless.
        try:
